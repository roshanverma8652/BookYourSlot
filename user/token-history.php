...
if(isset($_GET['cancel']))
		  {
		          mysqli_query($con,"update token set userStatus='0' where id = '".$_GET['id']."'");
                  $_SESSION['msg']="Your token is canceled !!";
		  }
?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select branch.branchname as branchname,token.*  from token join branch on branch.id=token.bname where token.userId='".$_SESSION['id']."'");
$cnt=1;
...
?>
											...
											<tr>
												...
												<td><?php echo $row['tokenDateTime'];?> 
												</td>
												<td><?php echo $row['postingDate'];?></td>
												<td>
                                                <?php $qrImg=$row['qrImg']; ?>
												<img src="userQr/<?php echo $qrImg?>" alt="">
												</td>
												<td>
...
{ ?>
	...
	<a href="token-history.php?id=<?php echo $row['id']?>&cancel=update" onClick="return confirm('Are you sure you want to cancel this token ?')"class="btn btn-transparent btn-xs tooltips" title="Cancel Token" tooltip-placement="top" tooltip="Remove">Cancel | </a>
	<a href="/bys/user/userQr/<?php echo $qrImg?>" download>Download QR</a>
