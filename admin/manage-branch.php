...
<body>
    ...
    <div class="container-fluid container-fullw bg-white">
                        ...
                        <div class="row">
                    <div class="col-md-12">
                        <h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Branches</span></h5>
...
?>
                ...
                <a href="edit-branch.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><img src="https://img.icons8.com/material/30/000000/edit--v1.png"/></i></a>
                                        
<a href="manage-branch.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><img src="https://img.icons8.com/material/30/000000/delete-forever--v1.png"/></i></a>
                                    </div>
                                    </td>
                                </tr>
