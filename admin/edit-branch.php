...
check_login();
$bid=intval($_GET['id']);// get doctor id
...
$email=$_POST['email'];
$sql=mysqli_query($con,"Update branch set supermarket='$supermarket',branchname='$bname',address='$address',contactno='$contactno',supEmail='$email' where id='$bid'");
if($sql)
{
...
<head>
    ...
    <title>Admin | Edit Branch Details</title>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Branch info</h5>
												</div>
												<div class="panel-body">
									<?php $sql=mysqli_query($con,"select * from branch where id='$bid'");
...
<?php } ?>
<hr />
													<form role="form" name="addsmart" method="post" onSubmit="return valid();">
...
<div class="form-group">
	...
	<input type="text" name="branchname" class="form-control" value="<?php echo htmlentities($data['branchname']);?>" >
														</div>
