                        ...
                        <table class="table table-hover" id="sample-table-1">
                           ...
                           <tbody>
                                ...
                                <tr>
                                    ...
                                    <a href="manage-users.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><img src="https://img.icons8.com/color/50/000000/delete-forever.png"/></a>
                                    </div>
                                        </td>
                                </tr>
