...
{
$sql=mysqli_query($con,"insert into supermarket(supermarket) values('".$_POST['supermarket']."')");
$_SESSION['msg']="Supermarket added successfully !!";
}

if(isset($_GET['del']))
		  {
		          mysqli_query($con,"delete from supermarket where id = '".$_GET['id']."'");
...
<head>
    ...
    <title>Users | Add Supermarkets</title>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Supermarkets</h5>
												</div>
												<div class="panel-body">
								<p style="color:green;"><?php echo htmlentities($_SESSION['msg']);?>
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
													<form role="form" name="supermarket" method="post" >
														<div class="form-group">
															<label for="exampleInputEmail1">
																Add Supermarket
															</label>
							<input type="text" name="supermarket" class="form-control"  placeholder="Enter Supermarket">
														</div>
									...
									<div class="row">
								<div class="col-md-12">
									<h5 class="over-title margin-bottom-15">Manage <span class="text-bold">Supermarkets</span></h5>
...
?>
											...
											<tr>
												...
												<td class="hidden-xs"><?php echo $row['supermarket'];?></td>
							...
							<a href="edit-supermarket.php?id=<?php echo $row['id'];?>" class="btn btn-transparent btn-xs" tooltip-placement="top" tooltip="Edit"><img src="https://img.icons8.com/material/30/000000/edit--v1.png"/></i></a>
													
	<a href="supermarket.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"><img src="https://img.icons8.com/material/30/000000/delete-forever--v1.png"/></i></a>
												</div>
												</td>
											</tr>
