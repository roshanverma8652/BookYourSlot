...
$sql=mysqli_query($con,"update  supermarket set supermarket='$supermarket' where id='$id'");
$_SESSION['msg']="Supermarket updated successfully !!";
} 
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Supermarket</h5>
												</div>
...
$id=intval($_GET['id']);
	$sql=mysqli_query($con,"select * from supermarket where id='$id'");
while($row=mysqli_fetch_array($sql))
{														
	?>		<input type="text" name="supermarket" class="form-control" value="<?php echo $row['supermarket'];?>" >
	<?php } ?>
														</div>
